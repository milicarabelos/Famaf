...
#endif
/*  que diferencia hay entre la especificación anterior y la que se encuentra en el pair.h de la carpeta
pair_d? 
 el encapsulamiento es mayor porque a los enteros los llamamos elem mi tad deberia aclarar para  que elementos es utilizable  */