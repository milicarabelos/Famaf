 ...
 */
    ...
    /* calculo el minimo historico*/
    printf("\n");
    min = menor_temperatura(array);
    printf("la menor temperatura historica es de %d \n", min);

    //creo un array para guardar los resultados por año
    int a[(YEARS)];
    mayor_temp_anho(array,a);
    
    // mostrar el arreglo resultante 
    simple_array_dump(a,(YEARS));

    //creo un array para guardar los resultados por año
     int arreglo[(YEARS)];
     procedimiento(array,arreglo);  
     simple_array_dump (arreglo, YEARS);
