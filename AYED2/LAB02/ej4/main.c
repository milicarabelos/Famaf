...
/* conclusiones: en ejemplos chicos podriamos decir que el algoritmo quick sort realiza muchas comparaciones si bien su tiempo de ejecucion es menor al 
de los otros algoritmos, pero en ejemplos grandes vemos la verdadera diferencia en este algoritmo que es mucho mas eficiente que los 2 anteriores
entre el selection_sort y el insertion_sort no hay mucha diferencia en cantidad de operaciones pero el seleccion_sort es el menos eficiente en tiempo */